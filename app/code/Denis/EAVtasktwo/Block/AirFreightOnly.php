...
class AirFreightOnly extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $afo_type = $this->_productCatalog->load($product_id)->getAirFreightOnly();
        $result = '';
        switch ($afo_type) {
            case 0:
                $result = 'none';
    ...
    {
        $afo_name = $this->_productCatalog->load($product_id)->getAirFreightOnly();
        $result = '';
        switch ($afo_name) {
            case 0:
                $result = 'None';
    ...
    {
        return $this->_productCatalog->load($product_id)->getWeight();
    }
